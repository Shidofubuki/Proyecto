...
<div class="titulo">
    <header>
    <a href="/index.php"><h1>Mi Valle</h1></a>
    </header>
    </div>
    ...
    <div class="formulariocaja">
		...
		<div class="logovai"><img src="/images/Simbolo tu valle.png"></div>
		<b>&#128231; Correo</b>
        ...
        <form id="frmregistrar" class="grupo-entradas" method="POST" action="registrar.php">
			<b>&#128231; Correo</b>
        <input type="email" class="cajaentradatexto" required name="txtcorreo">
			<b>&#128274; Contraseña</b>
        ...
        <input type="text" class="cajaentradatexto" required name="txtapellido">

        </i>&#128100;<b> Direccion</b>
        <input type="text" class="cajaentradatexto" required name="txtdireccion">

        </i>&#128100;<b> Telefono</b>
        <input type="text" class="cajaentradatexto" required name="txttelefono">
